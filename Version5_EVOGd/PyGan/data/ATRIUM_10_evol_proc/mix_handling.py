...
from J311_DEPL_QFISS import modify_depl_for_evoGd
...
def createLib(mix_numbering_option, draglib_name, anisotropy_level, self_shielding_method, resonance_correlation, transport_correction, composition_option, 
    ...
    if mix_numbering_option == "number_mix_families_per_enrichment":
        ...
        fill_lib_proc(proc_name, composition_option, mix_connectivity, resonance_correlation, modif_Q_fiss, modif_Q_NG)
...
def fill_lib_call(composition_option, mix_connectivity_dict, correlation_option, modif_Q_fiss, modif_Q_NG):
    """
    ...
    if modif_Q_fiss and modif_Q_NG:
        # Modify fission Q values for EDP0 (Serpent2-like) or QFIS (OpenMC-like) reaction rates normalisation.
        DEPL_struct = modify_depl_for_evoGd()
    elif modif_Q_fiss and not modif_Q_NG:
        print("Option not supoprted (yet) : modif Q fission, but not Q n,gamma")
    elif not modif_Q_fiss and modif_Q_NG:
        print("Option not supoprted (yet) : modif Q n,gamma, but not Q fission")
    else:
        # Default DRAGON option : read DEPL from draglib.
        DEPL_struct = "DEPL LIB: DRAGON FIL: <<Library>>\n"
...
def fill_lib_proc(file_name, composition_option, mix_connectivity_dict, correlation_option, modif_Q_fiss, modif_Q_NG):
    """
    ...
    modif_Q_fiss : bool
        Modify the DEPL structure at library creation to account for Serpent2's set edepmode 0 with corrected fission Q values.
    modif_Q_NG : bool
        Modify the DEPL structure at library creation to set Q values of (n,gamma) reations to 0. (Serpent2's set edepmode 0)
    """
    header = (  "* --------------------------------\n"
    ...
    lib_proc = (
        ...
        "*    CALL TO LIB: MODULE\n"
        "* --------------------------------\n"
        f"{fill_lib_call(composition_option, mix_connectivity_dict, correlation_option, modif_Q_fiss, modif_Q_NG)}\n"
        "* -----------------------------------------\n"
...
def mix_composition_definition(composition_option):
    ...
    fuel_composition = {
    "1": 
    {"O16": 4.66705E-02, "U234": 5.15910E-06, "U235": 5.67035E-04, "U238": 2.27631E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0},
    
    "2": 
    {"O16": 4.667480E-02, "U234": 7.039170E-06, "U235": 7.560370E-04, "U238": 2.257430E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0},
    
    "3": 
    {"O16": 4.667960E-02, "U234": 9.163680E-06, "U235": 9.686590E-04, "U238": 2.236200E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0},
    
    "4":
    {"O16": 4.668150E-02, "U234": 9.991530E-06, "U235": 1.051340E-03, "U238": 2.227940E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0},
    
    "5":
    {"O16": 4.668280E-02, "U234": 1.058330E-05, "U235": 1.110400E-03, "U238": 2.222040E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0},
    
    "6": 
    {"O16": 4.668410E-02, "U234": 1.117530E-05, "U235": 1.169460E-03, "U238": 2.216140E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0},
    
    "7": 
    {"O16": 4.621410E-02, "U234": 9.451580E-06, "U235": 9.945290E-04, "U238": 2.107540E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0,
    "Gd154": 2.986510E-05, "Gd155": 2.027540E-04, "Gd156": 2.804310E-04, "Gd157": 2.143990E-04, "Gd158": 3.403000E-04, "Gd160": 2.994740E-04},
    
    "8":
    {"O16": 4.621230E-02, "U234": 8.668470E-06, "U235": 9.163120E-04, "U238": 2.115350E-02, 
    "Pu239": 0.0, "Pu240": 0.0, "Pu241": 0.0, "Pu242": 0.0, "Am241":0.0, "Am242m":0.0, "Am243":0.0, "U236":0.0, "Np237":0.0, "Np239":0.0,
    "Gd154": 2.986510E-05, "Gd155": 2.027540E-04, "Gd156": 2.804310E-04, "Gd157": 2.143990E-04, "Gd158": 3.403000E-04, "Gd160": 2.994740E-04}
    }
