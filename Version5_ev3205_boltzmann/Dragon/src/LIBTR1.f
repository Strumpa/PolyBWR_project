...
*
   ...
   20 CONTINUE
      ...
      IF(NIN.LE.0) THEN
        WRITE (HSMG,'(36HLIBTR1: UNABLE TO OPEN LIBRARY FILE ,A12,1H.)')
     1  NAMFIL
        CALL XABORT(HSMG)
      ENDIF
*----
...
*----
      ...
      IER=KDRCLS(NIN,1)
      IF(IER.LT.0) THEN
        WRITE (HSMG,'(37HLIBTR1: UNABLE TO CLOSE LIBRARY FILE ,A12,1H.
     1  )') NAMFIL
        CALL XABORT(HSMG)
      ENDIF
*----
...
*
  ...
  885 FORMAT(1X,18A7)
  890 FORMAT(/32H PROCESSING MATXS LIBRARY NAMED ,A12,1H.)
