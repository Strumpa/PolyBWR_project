...
*----
     ...
     >    SGAR,SGAS,NELPIJ,IPIJK,PGAR(1),LEAKSW,1,NNPSYS(1),NPST,NBATCH,
     >    PROBKS,TITR,NALBP,ALBP)
          IF(IPIJK.EQ.4) THEN
...
*       --- ALLG VECTORIZATION
        ...
        ENDIF
        CALL EXCELP(IPTRK,IFTRAK,IMPX,NREG,NBMIX,NANI,MAT,VOL,KNORM,
     >  SGAR,SGAS,NELPIJ,IPIJK,PGARG(1,1),LEAKSW,NGRP,NPSYS(1),NPST,
     >  NBATCH,PROBKS,TITR,NALBP,ALBP)
