...
by a resonance self-shielding module (\moc{SHI:}, \moc{TONE:}, \moc{USS:}, \moc{AUTO:}) or
by a depletion calculation in module \moc{EVO:}. Such a structure (either stand-alone
...
included into a larger structure, such as an \dds{edition} structure or a
multi-paramater structure. It can be created by the \moc{LIB:} and \moc{EDI:} modules.
It can also be modified by module \moc{MAC:} or by a resonance self-shielding module. 
