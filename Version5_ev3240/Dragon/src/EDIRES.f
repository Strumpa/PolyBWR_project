*DECK EDIRES
     ...
     4 B2,DEN,ITYPE,LSISO,EMEVF,EMEVG,DECAY,YIELD,FIPI,PYIELD,ITRANC,
     5 LISO,NMLEAK)
*
*-----------------------------------------------------------------------
*
...
*----
     ...
     4 FIPI(NBISO,NMERGE),ITRANC,NMLEAK
...
*
      ...
      ALLOCATE(LSIS2(NBISO),IEVOL2(NBISO),IHNISO(3,NBISO*NMERGE),
...
*----
   ...
   10 CONTINUE
     ...
     4 ITYPE,IEVOL2,LSIS2,EMEVF,EMEVG,DECAY,YIELD,FIPI,PYIELD,ITRANC,
     5 LISO,NMLEAK)
*
...
*----
     ...
     1 TNISO,VOLISO,SDEN,WDLA)
      DEALLOCATE(ITYPRO,JPIFI,ISTOD,ISTYP,ISMIX,IHNIRF,IHNISO,IEVOL2,
     1 LSIS2)
      RETURN
*
