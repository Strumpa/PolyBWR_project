...
*           COMPARE THE TWO SINGLE PRECISION OR COMPLEX BLOCKS.
     ...
     3      MYDIR(ILEV)
            ...
            EPSAVG=EPSAVG+ABSEP
  100       CONTINUE
            IF(INGRO.EQ.0) GO TO 180
            EPSAVG=EPSAVG/REAL(ILON1)
            WRITE (6,'(/5H LEN=,I6,5X,7HEPSMAX=,1P,E12.5,10H IN COMPON,
     1      3HENT,I6/16X,7HEPSAVG=,E12.5)') ILON1,EPSMAX,INGRO,EPSAVG
