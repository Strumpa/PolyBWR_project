...
*       L_KINET object
     ...
     1 //'AND L_FLUX/L_KINET OBJECTS')
      ...
      LZ=ISTATE(16)
*----
*  RECOVER FUELMAP AND MATEX INFORMATION, INCLUDING H-FACTOR
*----
      ISTATE(:NSTATE)=0
     ...
     1   //' NUMBER OF REGIONS IN FUEL MAP OR TRACK.')
        ...
        HFC(:NMIX*NGRP)=0.0
        CALL LCMLEN(IPMTX,'H-FACTOR',LENGT,ITYP)
        IF(LENGT.EQ.0)CALL XABORT('@FLPDRV: MISSING H-FACTOR IN MATEX.')
        CALL LCMGET(IPMTX,'H-FACTOR',HFC)
      ELSE
*----
*  RECOVER INFORMATION FROM MACROLIB
*----
