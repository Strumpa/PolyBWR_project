...
*----
      ...
      INTEGER, DIMENSION(:,:,:), ALLOCATABLE :: MIXT,MATXYZ
...
*----
     ...
     2  11HDRAGON FLUX,5X,10HFISSION XS)')
      ...
      DO I=1,NDETC
        ...
        ININY=NINY(I)
        ININZ=NINZ(I)
        ALLOCATE(MATXYZ(ININX,ININY,ININZ),TFLUX(ININX,ININY,ININZ,NG))
        DO IG=1,NG
...
*           Analytic nodal method (ANM)
     ...
     2      KFLX,KN,ININX,ININY,ININZ,ICORN,MATXYZ,TFLUX(1,1,1,IG))
            DEALLOCATE(KN)
          ELSE
...
*       integrate along axial direction
        ...
        DEALLOCATE(SIGF,DFLUX,MIXT,AFLUX,TFLUX,MATXYZ)
      ENDDO
*----
*  RELEASE MEMORY
*----
