...
*       build a microlib
     ...
     2  LXS,LRES,LPURE,B2)
        IF(IMPX.GT.0) THEN
          ...
          WRITE(IOUT,310) (ISTATE(I),I=13,15),(ISTATE(I),I=17,25)
        ENDIF
      ENDIF
*
...
*
  ...
  310 FORMAT(7H NEDMAC,I6,34H   (NUMBER OF CROSS SECTION EDITS)/
     ...
     4 10H GAP INFO)/
     5 7H NW    ,I6,47H   (=0: FLUX WEIGHTING FOR P1 INFO; =1: CURRENT,
     6 23H WEIGHTING FOR P1 INFO))
