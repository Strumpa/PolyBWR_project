...
class Serpent2_case:
    def __init__(self, case_name, edep_id, pcc_id, lib_name, tracked_nuclides):
        self.case_name = case_name
        self.edep_id = edep_id
        self.pcc_id = pcc_id
        self.lib_name = lib_name
        self.tracked_nuclides = tracked_nuclides
        self.units = "MWd/kgU" # Default Serpetn2 units for BU
    ...
    def set_ref_case(self, ref_lib, ref_edep, ref_pcc):
        ...
        for S2_case in self.S2_cases_list:
            if S2_case.edep_id == ref_edep and S2_case.pcc_id == ref_pcc and S2_case.lib_name == ref_lib:
                print(f"Reference case set to {S2_case.case_name} with edepmode {S2_case.edep_id} and pcc {S2_case.pcc_id}")
