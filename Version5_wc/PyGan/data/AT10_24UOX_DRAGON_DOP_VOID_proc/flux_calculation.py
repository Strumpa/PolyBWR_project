## PyGan function interfacing with DRAGON5 flux calculation procedures
# Author : R. Guasch
# Purpose : Validation of DRAGON5 cross sections generation fo multiphysics applications
