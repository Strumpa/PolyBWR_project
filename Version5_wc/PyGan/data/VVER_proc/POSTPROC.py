...
def POSTPROC(pyCOMPO,ListeCOMPO,name_geom,suffixe,VISU_param,form,Nmin):
    ...
    if visu_SERPENT==1 or visu_COMP==1 or visu_DELTA==1 :
        ...
        # --- Keff
        res=serpentTools.read(SERPENT_path+name_geom+"_res.m")
        ...
        # --- BU
        depFile = SERPENT_path+name_geom+'_dep.m'
