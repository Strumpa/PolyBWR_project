...
class Serpent2_case:
    ...
    def read_S2_outputs(self):
        # Read the results
        self.res = st.read(f"/home/p117902/working_dir/Serpent2_para_bateman/Linux_aarch64/{self.case_name}_mc_res.m")
        self.keffs = self.res.resdata["absKeff"].T[0]
        self.sigmas_keff = self.res.resdata["absKeff"].T[1]
        self.depl = st.read(f"/home/p117902/working_dir/Serpent2_para_bateman/Linux_aarch64/{self.case_name}_mc_dep.m")
