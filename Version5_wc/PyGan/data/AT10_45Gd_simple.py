...
## Simpler version with only one fuel region in pellet.
...
draglibs_to_test = ["endfb8r1_295", "endfb81295K2"] # "endfb8r1_295", "endfb81295K" : with total KERMA (MT301), "endfb81295K2" : with modified KERMA (MT301-MT318)+MT458 data.
...
#
burnup_points_to_test = ["Gd_autop3"] #"Gd_autop3" # "Gd_autop4", "Gd_autop5", "Gd", "Gd2_autop6"
...
time_integrator_list = ["EXTR", "CECE", "CECM"]
...
path=os.getcwd()
save_dir_D5 = f"{path}/AT10_45Gd_1fuel_reg_results/D5_{evaluation}"
save_dir_S2 = f"{path}/AT10_45Gd_1fuel_reg_results/S2_{evaluation}"
save_dir_comparison = f"{path}/AT10_45Gd_1fuel_reg_results/Comparison_{evaluation}"
