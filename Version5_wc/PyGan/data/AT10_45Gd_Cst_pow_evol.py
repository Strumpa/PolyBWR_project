...
path=os.getcwd()
save_dir_D5 = f"{path}/AT10_45Gd_Cst_pow_evol_results/D5"
save_dir_S2 = f"{path}/AT10_45Gd_Cst_pow_evol_results/S2"
save_dir_comparison = f"{path}/AT10_45Gd_Cst_pow_evol_results/Comparison"
