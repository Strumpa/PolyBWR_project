...
# draglibs : 
# "endb8r1" : "v5.0" endb8r1 shem295 draglib, 
# "endfb8r1v5p1" : "v5.1" endfb8r1 shem295 draglib, 
# "endfb8r1dec" : "v5.1" endfb8r1 shem295 draglib with idecay flag : should be equivalent to Serpent2 edepmode 0

draglibs_to_test = ["endfb8r1dec", "endfb8r1v5p1"] #["J311_295E0", "J311_295", "J311_295K"] 
...
#
burnup_points_to_test = ["Gd_autop3"] #["Gd_autop3", "Gd2_autop6"] #"Gd_autop3" # "Gd_autop4", "Gd_autop5", "Gd", "Gd2_autop6"
...
# "EDP0" : (H_i / H_U235) * 202.27 MeV --> Serpent2 energy normalisation 

edep_opt = "EDP0" # "GLOB", "NOGL"
        ...
        for corr in corr_options:
            ...
            for burnup_points in burnup_points_to_test:
                for time_integrator in time_integrator_list:
                    ...
                    name_compo = f"_CPO_{draglib_name}_{ssh_option}_{corr_name}_{tracking_option}_{burnup_points}_{solver_option}_{saturation_option}_{time_integrator}_{edep_opt}"
                    if time_integrator == "CECM":
                        CPO = CECM("COMPO", LIB, TRK, TF_EXC, TRK_SS, TF_EXC_SS, StepList, name_compo, solver_option, edep_opt)
                    elif time_integrator == "CECE":
                        CPO = CECE("COMPO", LIB, TRK, TF_EXC, TRK_SS, TF_EXC_SS, StepList, name_compo, solver_option, edep_opt)
                    elif time_integrator == "EXTR":
                        CPO = BU_C("COMPO", LIB, TRK, TF_EXC, TRK_SS, TF_EXC_SS, StepList, name_compo, ssh_option, solver_option, edep_opt, saturation_option, rates_extr="EXTR")
                    elif time_integrator == "NOEX":
                        CPO = BU_C("COMPO", LIB, TRK, TF_EXC, TRK_SS, TF_EXC_SS, StepList, name_compo, ssh_option, solver_option, edep_opt, saturation_option, rates_extr="NOEX")
                    elif time_integrator == "EXTR2":
                        CPO = BU_EXTR2("COMPO", LIB, TRK, TF_EXC, TRK_SS, TF_EXC_SS, StepList, name_compo, ssh_option, solver_option, edep_opt, saturation_option)
