...
\begin{equation}
d_{m,g} = {1\over 3\gamma(B,\bar\Sigma_g)}\left[ {\left<\phi_g\right>_m\over \left<\Sigma_g\phi_g\right>_m}\right]={1\over 3\gamma(B,\bar\Sigma_g)\bar\Sigma_{m,g}}
\label{eq:eq5.36c}
\end{equation}
...
in zone $m$. The $\gamma(B,\bar\Sigma_g)$ factor is equal to one with $P_n$ leakage models or to a group-dependent value with $B_n$
leakage models.\cite{PIP2009} Here, $\bar\Sigma_g$ is the global averaged macroscopic total cross section in group $g$ defined as
\begin{equation}
\bar\Sigma_g={\left<\Sigma_g\phi_g\right> \over \left<\phi_g\right>}.
\label{eq:eq5.36d}
\end{equation}
\
...
\begin{equation}
d_{m,g}\left<\Sigma_g\phi_g\right>_m = {1\over \gamma(B,\bar\Sigma_g)}\left[ {\left<\phi_g\right>_m\over 3}+
...
\begin{equation}
d_{m,g} = {1\over 3}\left[ {\left<\phi_g\right>_m\over \gamma(B,\bar\Sigma_g)\left<\Sigma_g\phi_g\right>_m-\left<\Sigma_{{\rm s1},g}\phi_g\right>_m}\right]=
{1\over 3\left[\gamma(B,\bar\Sigma_g)\bar\Sigma_{m,g}-\bar\Sigma_{{\rm s1},m,g}\right]} .
\label{eq:eq5.36c}
\end{equation}
