...
This module is used to extract macroscopic cross-section data from a FMAC-M {\sc ascii} file.
Transition source information from companion particles is recovered from the FMAC-M file and written in the
output {\sc macrolib}.
...
\item[\moc{PARTICLE}] keyword used to specify the type of particle
corresponding to the {\sc macrolib}, that is, the secondary state of the
