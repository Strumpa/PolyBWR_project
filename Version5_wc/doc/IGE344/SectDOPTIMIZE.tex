...
\item Anderson acceleration flag {\tt M:} ${S}^{o}_{15}$, where

\begin{displaymath}
\mathcal{S}^{o}_{15} = \left\{
\begin{array}{rl}
 0 & \textrm{free iterations} \\
 \ge 1 & \textrm{window size of the Anderson acceleration.} \\
\end{array} \right.
\end{displaymath}
...
\OptDbleEnr
{ANDERSON-XX\blank{1}}{$N_{var}\times(M+1)$}{${S}^{o}_{15}>0$}{}
{Previous values of the iterate vector over the Anderson window.}

\OptDbleEnr
{ANDERSON-GG\blank{1}}{$N_{var}\times(M+1)$}{${S}^{o}_{15}>0$}{}
{Previous values of the gradient vector over the Anderson window.}
