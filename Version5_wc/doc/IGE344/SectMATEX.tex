...
\IntEnr
 {MAT-INIT\blank{4}}{$N_{tot}$}
 {The material mixture indices for each region, as defined before the module
 {\tt RESINI:} is called. The virtual-region indices are set to 0.}

\IntEnr
 {MAT\blank{9}}{$N_{tot}$}
 {The material mixture indices for each region and including the device
...
\IntEnr
 {MATEX\blank{7}}{$N_{el}$}
 {Corresponding region indices in the geometry before the call to module {\tt USPLIT}.}
