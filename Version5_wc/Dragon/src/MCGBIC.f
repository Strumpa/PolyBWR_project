*DECK MCGBIC
     ...
     2            NZON,MATALB,M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,
     3            SOUR,IAAC,ISCR,LC,LFORW,PACA,ITST,MAXI,QFR,PHIIN,CAZ0,
...
*----
     ...
     2 NBCDA,ISCR,LPS,NGIND(NGEFF),LNCONV,NLIN,NFUNL,
     3 KEYFLX(NREG,NLIN,NFUNL),KEYCUR(NLONG-NREG),STIS,NPJJM,
     4 MATALB(-NSOUT:NREG),N2REG,N2SOU,NZP,IDIR,NBATCH
      REAL QFR(N,NGEFF),PHIIN(N,NGEFF),CPO(NMU),ZMU(NMU),WZMU(NMU),
     1 V(NLONG),EPS(NGEFF),EPSI,REPSI(MAXI,NGEFF),SIGAL(-NBCDA:M,NGEFF),
     2 DELU,FACSYM
...
*     a first iteration
     ...
     2     NMAX,NANGL,NREG,NSOUT,NBCDA,NG,NGEFF,NGIND,SOUR,IAAC,ISCR,
     3     LC,LFORW,PACA,EPSINT,MAXINT,NLIN,NFUNL,KEYFLX,KEYCUR,QFR,
     4     PHIIN(1,1),CAZ0,CAZ1,CAZ2,CPO,ZMU,WZMU,V,SIGAL,LPS,NCONV,
     5     .FALSE.,STIS,NPJJM,REBFLG,LPRISM,N2REG,N2SOU,NZP,DELU,FACSYM,
     6     IDIR,NBATCH)
      DO II=1,NGEFF
         IF (NCONV(II)) THEN
            DO J=1,N
...
*     evaluate RHS of the linear system
     ...
     2        M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,NG,NGEFF,NGIND,
     2        SOUR,IAAC,ISCR,LC,LFORW,PACA,EPSINT,MAXINT,NLIN,NFUNL,
     3        KEYFLX,KEYCUR,QFR,RHS(1,1),CAZ0,CAZ1,CAZ2,CPO,ZMU,WZMU,
     4        V,SIGAL,LPS,NCONV,.FALSE.,STIS,NPJJM,REBFLG,LPRISM,N2REG,
     5        N2SOU,NZP,DELU,FACSYM,IDIR,NBATCH)
         DO II=1,NGEFF
            IF (NCONV(II)) THEN
               DO J=1,N
...
*
     ...
     2     NMAX,NANGL,NREG,NSOUT,NBCDA,NG,NGEFF,NGIND,SOUR,IAAC,ISCR,
     3     LC,LFORW,PACA,EPSINT,MAXINT,NLIN,NFUNL,KEYFLX,KEYCUR,QFR,
     4     PI(1,1),CAZ0,CAZ1,CAZ2,CPO,ZMU,WZMU,V,SIGAL,LPS,NCONV,
     5     .FALSE.,STIS,NPJJM,REBFLG,LPRISM,N2REG,N2SOU,NZP,DELU,FACSYM,
     6     IDIR,NBATCH)
      ITER=ITER+1
      DO II=1,NGEFF
...
*
     ...
     1        IPTRK,IFTRAK,IPMACR,NDIM,K,N,NLONG,PHIOUT,NZON,MATALB,
     2        M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,NG,NGEFF,NGIND,
     3        SOUR,IAAC,ISCR,LC,LFORW,PACA,EPSINT,MAXINT,NLIN,NFUNL,
     4        KEYFLX,KEYCUR,QFR,SI(1,1),CAZ0,CAZ1,CAZ2,CPO,ZMU,WZMU,
     5        V,SIGAL,LPS,NCONV,.FALSE.,STIS,NPJJM,REBFLG,LPRISM,N2REG,
...
*
     ...
     2        M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,NG,NGEFF,NGIND,
     3        SOUR,IAAC,ISCR,LC,LFORW,PACA,EPSINT,MAXINT,NLIN,NFUNL,
     4        KEYFLX,KEYCUR,QFR,PI(1,1),CAZ0,CAZ1,CAZ2,CPO,ZMU,WZMU,
     5        V,SIGAL,LPS,NCONV,.FALSE.,STIS,NPJJM,REBFLG,LPRISM,N2REG,
     6        N2SOU,NZP,DELU,FACSYM,IDIR,NBATCH)
         ITER=ITER+1
         DO II=1,NGEFF
...
*     determine final residual norm
      ...
      CALL MCGFL1(SUBFFI,SUBFFA,SUBDLC,SUBSCH,CYCLIC,KPSYS,IPRINT,IPTRK,
     1     IFTRAK,IPMACR,NDIM,K,N,NLONG,PHIOUT,NZON,MATALB,M,NANI,NMU,
     2     NMAX,NANGL,NREG,NSOUT,NBCDA,NG,NGEFF,NGIND,SOUR,0,0,LC,LFORW,
