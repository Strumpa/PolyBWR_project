*DECK MCGMRE
     ...
     4           CAZ1,CAZ2,CPO,ZMU,WZMU,VOL,EPS,ERRTOL,REPSI,NSTART,
     5           SIGAL,LPS,NGROUP,NGEFF,NGIND,NCONV,LNCONV,NLIN,NFUNL,
     6           KEYFLX,KEYCUR,STIS,NPJJM,REBFLG,LPRISM,N2REG,N2SOU,NZP,
     7           DELU,FACSYM,IDIR,NBATCH)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
     ...
     2 NSOUT,NBCDA,ISCR,LPS,NGIND(NGEFF),LNCONV,NLIN,NFUNL,
     ...
     2 SIGAL(-NBCDA:M,NGEFF),DELU,FACSYM
...
*---
     ...
     2       MATALB,M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,NGROUP,NGEFF,
     3       NGIND,SOUR,IAAC,ISCR,LC,LFORW,PACA,EPSINTO,MAXINT,NLIN,
     4       NFUNL,KEYFLX,KEYCUR,QFR,PHIIN(1,1),CAZ0,CAZ1,CAZ2,CPO,ZMU,
     5       WZMU,VOL,SIGAL,LPS,NCONV,.FALSE.,STIS,NPJJM,REBFLG,LPRISM,
...
*---
     ...
     2         MATALB,M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,NGROUP,
     3         NGEFF,NGIND,SOUR,IAAC,ISCR,LC,LFORW,PACA,EPSINTO,MAXINT,
     4         NLIN,NFUNL,KEYFLX,KEYCUR,QFR,RHS(1,1),CAZ0,CAZ1,CAZ2,CPO,
     5         ZMU,WZMU,VOL,SIGAL,LPS,NCONV,.FALSE.,STIS,NPJJM,REBFLG,
...
*---
     ...
     2         MATALB,M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,NGROUP,
     3         NGEFF,NGIND,SOUR,IAAC,ISCR,LC,LFORW,PACA,EPSINTO,MAXINT,
     4         NLIN,NFUNL,KEYFLX,KEYCUR,QFR,GAR(1,1),CAZ0,CAZ1,CAZ2,CPO,
     5         ZMU,WZMU,VOL,SIGAL,LPS,NCONV,.FALSE.,STIS,NPJJM,REBFLG,
     6         LPRISM,N2REG,N2SOU,NZP,DELU,FACSYM,IDIR,NBATCH)
          V(:,:,K+1)=V(:,:,K)-FLOUT(:,:)+RHS(:,:)
          ERROR=0.0D0
