...
*----
      INTERFACE
        SUBROUTINE SUBPJJ_TEMPLATE(M,N,LPS,IS,JS,H,NOM,NZON,TR,W,NFI,
     1                   NREG,PJJ,PSJ,IMU,NMU,NFUNL,NMOD,NPJJM,TRHAR,
     2                   LPJJAN,PJJIND,MODST)
          INTEGER M,N,NFI,NREG,LPS,IS(NFI-NREG+1),JS(LPS),NZON(NFI),
     1    NOM(N),IMU,NMU,NFUNL,NMOD,NPJJM,PJJIND(NPJJM,2),MODST
