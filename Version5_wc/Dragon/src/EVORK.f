...
*
      NSUPL=N-NSUPF
      H=HTRY
   10 CALL ALLUM(N,ADPL(1,1),Y,AK(1,1),MU1,IMA,1)
      CALL ALLUM(N,ADPL(1,2),Y,YGAR,MU1,IMA,1)
      DO 25 I=1,NSUPF
      DO 20 J=1,NFISS
   ...
   30 CONTINUE
*
      CALL ALLUM(N,ADPL(1,1),YTEMP,AK(1,2),MU1,IMA,1)
      CALL ALLUM(N,ADPL(1,2),YTEMP,YGAR,MU1,IMA,1)
      DO 45 I=1,NSUPF
      DO 40 J=1,NFISS
   ...
   50 CONTINUE
*
      CALL ALLUM(N,ADPL(1,1),YTEMP,AK(1,3),MU1,IMA,1)
      CALL ALLUM(N,ADPL(1,2),YTEMP,YGAR,MU1,IMA,1)
      DO 65 I=1,NSUPF
      DO 60 J=1,NFISS
   ...
   70 CONTINUE
*
      CALL ALLUM(N,ADPL(1,1),YTEMP,AK(1,4),MU1,IMA,1)
      CALL ALLUM(N,ADPL(1,2),YTEMP,YGAR,MU1,IMA,1)
      DO 85 I=1,NSUPF
      DO 80 J=1,NFISS
   ...
   90 CONTINUE
*
      CALL ALLUM(N,ADPL(1,1),YTEMP,AK(1,5),MU1,IMA,1)
      CALL ALLUM(N,ADPL(1,2),YTEMP,YGAR,MU1,IMA,1)
      DO 105 I=1,NSUPF
      DO 100 J=1,NFISS
  ...
  110 CONTINUE
*
      CALL ALLUM(N,ADPL(1,1),YTEMP,AK(1,6),MU1,IMA,1)
      CALL ALLUM(N,ADPL(1,2),YTEMP,YGAR,MU1,IMA,1)
      DO 125 I=1,NSUPF
      DO 120 J=1,NFISS
