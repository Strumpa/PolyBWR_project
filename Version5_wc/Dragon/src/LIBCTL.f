...
*----
      IF(C_ASSOCIATED(IPLIBX)) THEN
        ...
        CALL LCMGTC(IPLIBX,'SIGNATURE',12,1,HSIGN)
        ...
        DO NNMIX=1,NBMIX
          ...
          DO ISO=1,NBISO
            IF(ISOMIX(ISO).EQ.NNMIX) THEN
              WRITE(HSMG,'(15HLIBCTL: MIXTURE,I6,18H IS ALREADY DEFINE,
...
*
  ...
  180 FORMAT(/16H LIBCTL: OPTIONS/8H -------/
     ...
     2 7H NLIB  ,I6,32H   (NUMBER OF SETS OF LIBRARIES)/
     3 7H NBISO ,I6,36H   (NUMBER OF ISOTOPES OR MATERIALS)/
     4 7H NBMIX ,I6,23H   (NUMBER OF MIXTURES)/
     5 7H NDEPL ,I6,33H   (NUMBER OF DEPLETING ISOTOPES)/
     6 7H NCOMB ,I6,33H   (NUMBER OF DEPLETING MIXTURES)/
     7 7H NEDMAC,I6,34H   (NUMBER OF CROSS SECTION EDITS)/
     8 7H NGRO  ,I6,28H   (NUMBER OF ENERGY GROUPS)/
     9 7H NL    ,I6,30H   (NUMBER OF LEGENDRE ORDERS)/
     ...
     4 7H ISOADD,I6,37H   (0=COMPLETE BURNUP CHAIN/1=DO NOT))
