...
SUBROUTINE SALACG(FGEO ,ITRACK, RCUTOF, IPRINT, GG)
  ...
  INTEGER NALBG,OK,I,J,NREG,ELEM,NFREG,LEAK,NSOUT,INDEX,MMAX,NBCDA
  ...
  ! boundary conditions structures
     print *,'SALACG: debugggg GG%NALBG=',GG%NALBG,'GG%NB_SURF2=',GG%NB_SURF2,' NSOUT=',NSOUT,' ISPEC=',ISPEC
