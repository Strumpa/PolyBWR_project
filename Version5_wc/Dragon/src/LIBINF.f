*DECK LIBINF
     ...
     1 NL,NW,ITRANC,NLIB,NCOMB,NEDMAC,NBMIX,ISONAM,ISONRF,ISOMIX,DENISO,
...
*----
      TYPE(C_PTR) IPLIB
      INTEGER MAXISO,MAXLIB,MAXED,MAXMIX,NBISO,NGRO,NL,NW,ITRANC,
     1 NLIB,NCOMB,NEDMAC,NBMIX,ISONAM(3,MAXISO),ISONRF(3,MAXISO),
