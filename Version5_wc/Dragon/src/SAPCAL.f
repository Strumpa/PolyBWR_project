*DECK SAPCAL
      SUBROUTINE SAPCAL(IMPX,IPSAP,IPDEPL,IPMICR,LCRON)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
      TYPE(C_PTR) IPSAP,IPDEPL,IPMICR
      INTEGER IMPX
      LOGICAL LCRON
*----
*  LOCAL VARIABLES
...
*----
      ...
      CALL SAPCA2(IPSAP,IPMICR,NREA,NISO,NMAC,NADRX,NED,NPRC,NG,NL,
...
*----
      IF((IDF.EQ.2).OR.(IDF.EQ.3)) THEN
        CALL SAPIDF(IPSAP,IPMICR,NG,NMIL,ICAL,IDF,FNORM,REGFLX)
      ENDIF
      DEALLOCATE(REGFLX)
*----
*  COMPLETE DIMSAP.
...
*----
      IF(NISYS.GT.0) THEN
         CALL SAPGEY(IPSAP,IPMICR,NISO,NMAC,NG,NMIL,NBISO,ICAL,NDFI,
     1   NISFS,NISPS,NISYS)
      ENDIF
*
