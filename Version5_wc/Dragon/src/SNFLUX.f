...
*
      USE GANLIB
      USE SNFCD_MOD ! Cartesian solution
      USE SNFHD_MOD ! hexagonal solution
*----
...
*----
      ...
      ELSE
         ALLOCATE(ISBSM(0,0,0))
      ENDIF
      IF(SUM(NBS).NE.0.AND.ALLOCATED(ISBSM)) THEN
...
*------------
   ...
   40   CONTINUE
        ...
        ! FLUX CALCULATION
        CALL SNFC1D(NUN,NGEFF,INCONV,LX,ISCHM,IELEM,NM,NMX,
     1  NBMIX,NPQ,NSCT,U,MAT,VOL,SGAR,NCODE,ZCODE,QEXT,LFIXUP,LSHOOT,MN,
     2  DN,WX,CST,ISBS,SUM(NBS),ISBSM,BS,MAXL,FUNKNO,IBFP,EELEM,NME,
     3  ESCHM)
...
*------------
        ...
        NME=IELEM
        NPQ=NLF
        IF((IELEM*NPQ+NM*NSCT)*NREG.GT.NUN) THEN
   ...
   80   CONTINUE
     ...
     1  NBMIX,NPQ,NSCT,U,MAT,VOL,SGAR,NCODE,ZCODE,QEXT,LFIXUP,LSHOOT,MN,
     2  DN,WX,CST,ISBS,SUM(NBS),ISBSM,BS,MAXL,FUNKNO,IBFP,EELEM,NME,
     3  ESCHM,ESTOPW,DELTAE,WE,ISLG,FLUXC)
...
*------------
  ...
  200   CONTINUE ! END OF ENERGY LOOP
       ...
       ! FLUX CALCULATION
        CALL SNFC2D(NUN,NGEFF,IMPX,INCONV,NGIND,LX,LY,ISCHM,IELEM,NM,
     1  NMX,NMX,NBMIX,NPQ,NSCT,MAT,VOL,SGAR,NCODE,ZCODE,QEXT,LFIXUP,
     2  DU,DE,W,MRM,MRMY,DB,DA,MN,DN,WX,WX,CST,ISBS,SUM(NBS),ISBSM,
     3  BS,MAXL,FUNKNO,NKBA,IBFP,EELEM,NME,ESCHM)
...
*------------
  ...
  250   CONTINUE ! END OF ENERGY LOOP
     ...
     1  NMX,NMX,NBMIX,NPQ,NSCT,MAT,VOL,SGAR,NCODE,ZCODE,QEXT,LFIXUP,
     2  DU,DE,W,MRM,MRMY,DB,DA,MN,DN,WX,WX,CST,ISBS,SUM(NBS),ISBSM,
     3  BS,MAXL,FUNKNO,NKBA,IBFP,EELEM,NME,ESCHM,ESTOPW,DELTAE,
     4  WE,ISLG,FLUXC)
...
*----
     ...
     1  //'XT OVERFLOW(6a)')
        ...
        CALL C_F_POINTER(DB_PTR,DB,(/ LY*LZ*NPQ /))
        CALL C_F_POINTER(DA_PTR,DA,(/ LY*LZ*NPQ /))
        CALL C_F_POINTER(WX_PTR,WX,(/ IELEM+1 /))
        CALL C_F_POINTER(CST_PTR,CST,(/ IELEM /))
        CALL C_F_POINTER(IL_PTR,IL,(/ NSCT /))
        CALL C_F_POINTER(MN_PTR,MN,(/ NPQ*NSCT /))
  ...
  340   CONTINUE ! END OF ENERGY LOOP
        ...
        ! FLUX CALCULATION
        CALL SNFC3D(NUN,NGEFF,IMPX,INCONV,NGIND,LX,LY,LZ,ISCHM,IELEM,NM,
     1  NMX,NMX,NMX,NBMIX,NPQ,NSCT,MAT,VOL,SGAR,NCODE,ZCODE,QEXT,LFIXUP,
     2  DU,DE,DZ,W,MRMX,MRMY,MRMZ,DC,DB,DA,MN,DN,WX,WX,WX,CST,ISBS,
     3  SUM(NBS),ISBSM,BS,MAXL,FUNKNO,NKBA,IBFP,EELEM,NME,ESCHM)
...
*------------
        ...
        CALL C_F_POINTER(MRMY_PTR,MRMY,(/ NPQ /))
        CALL C_F_POINTER(MRMZ_PTR,MRMZ,(/ NPQ /))
        CALL C_F_POINTER(DC_PTR,DC,(/ LY*LZ*NPQ /))
        CALL C_F_POINTER(DB_PTR,DB,(/ LX*LZ*NPQ /))
        CALL C_F_POINTER(DA_PTR,DA,(/ LX*LY*NPQ /))
        CALL C_F_POINTER(WX_PTR,WX,(/ IELEM+1 /))
        CALL C_F_POINTER(WE_PTR,WE,(/ EELEM+1 /))
        CALL C_F_POINTER(CST_PTR,CST,(/ MAX(IELEM,EELEM) /))
  ...
  390   CONTINUE ! END OF ENERGY LOOP
     ...
     1  NMX,NMX,NMX,NBMIX,NPQ,NSCT,MAT,VOL,SGAR,NCODE,ZCODE,QEXT,LFIXUP,
     2  DU,DE,DZ,W,MRMX,MRMY,MRMZ,DC,DB,DA,MN,DN,WX,WX,WX,CST,ISBS,
     3  SUM(NBS),ISBSM,BS,MAXL,FUNKNO,NKBA,IBFP,EELEM,NME,ESCHM,ESTOPW,
     4  DELTAE,WE,ISLG,FLUXC)
...
*------------
  ...
  440   CONTINUE ! END OF ENERGY LOOP
        ...
        ! FLUX CALCULATION
        CALL SNFH2D(NUN,NGEFF,IMPX,INCONV,NGIND,NHEX,ISPLH,SIDE,
     1  IELEM,NM,NMX,NMX,NBMIX,NPQ,NSCT,MAT,VOL,SGAR,QEXT,LFIXUP,DU,
     2  DE,W,DB,DA,MN,DN,WX,WX,CST,LOZSWP,COORDMAP,FUNKNO,ISCHM)
...
*------------
  ...
  490   CONTINUE ! END OF ENERGY LOOP
        ...
        ! FLUX CALCULATION
        CALL SNFH3D(NKBA,NUN,NGEFF,IMPX,INCONV,NGIND,NHEX,LZ,ISPLH,
     1  SIDE,IELEM,NM,NMX,NMX,NMX,NBMIX,NPQ,NSCT,MAT,VOL,SGAR,
     2  NCODE,ZCODE,QEXT,LFIXUP,DU,DE,DZ,W,MRMZ,DC,DB,DA,MN,
     3  DN,WX,WX,WX,CST,LOZSWP,COORDMAP,FUNKNO,ISCHM)
