*DECK MCGPTA
      SUBROUTINE MCGPTA(NFI,NREG,NLONG,NBCDA,M,NANGL,NMU,LC,NGEFF,
...
*----
      INTEGER NFI,NREG,NLONG,NBCDA,M,NANGL,NMU,LC,NGEFF,IANGL,NSEG,
     ...
     4 N3TRTMT,N3SE,N3SETMT,N2TPROC,SSYM
      REAL ZMU(NMU),WZMU(NMU),SIGAL(-NBCDA:M,NGEFF),XSW(0:M,NGEFF),
...
*        this track has encountered the top boundary -> it is reflected
     ...
     1           NOM3D0(1,1),W3D,W3D01,H3D,H3D0(1,1),LFORC,NTPROC)
         ...
         ENDDO
         CALL MCGDS1(SUBDS2,SUBDSP,SUBDSC,N3D,NMU,NGEFF,W3D,H3D,
     1        ZMU,WZMU,NOM3D,NZONA,NLONG,NFI,3,LC,NBCDA,M,KM,IM,
