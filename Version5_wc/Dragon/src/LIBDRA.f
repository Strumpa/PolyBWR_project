...
*
     ...
     2      LADD,LGOLD,SIGS(1,1),SCAT(1,1,1),TOTAL,ZNPHI,SIGF(1,1),
     3      CHI(1,1),CHI4G(1,1),SADD(1,1),GOLD(1),BIN(1))
         ELSE
*----
...
*----
  ...
  125       CONTINUE
     ...
     >      1P,E12.4,18H KELVIN. FACTOR = ,E12.4)') TEMP(ITM),TERPM
            ...
            CALL LIBDRB (IPDRL,NGRO,NL,NDEL0,NBESP,SN(1,IMX),SB(1,IMX),
     1      NED,HVECT,DELTA,LBIN,NFS,EBIN,IMPX,NGF,NGFR,LSCAT,LSIGF,
     2      LADD,LGOLD,SIGS2(1),SCAT2(1),TOTAL2,ZNPHI2,SIGF2(1),CHI2(1),
     3      CHI4G2(1),SADD2(1),GOLD2(1),BIN2(1))
            CALL LCMSIX (IPDRL,' ',2)
            DO 130 IG=1,NGRO
