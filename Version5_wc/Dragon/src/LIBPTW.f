...
*----
     ...
     1 SADD,ZDEL,DELTG,TBIN,SBIN,FBIN,EBIN
      ...
      REAL NFTOT(NGRO,NDIL),HFACT(NGRO,NDIL),KAPF
*----
...
*         DO 100 IDIL=1,NDIL
*         PRINT *, "IDIL=",IDIL
*         CALL LCMGET(KPTMP,"NFTOT",NFTOT(1,IDIL))
*         CALL LCMGET(KPTMP,"H-FACTOR",HFACT(1,IDIL))
*         DO 110 IGR=1,NGRO
*           KAPF=HFACT(IGR,IDIL)/NFTOT(IGR,IDIL)
