...
*     DEFAULT OPTIONS:
      ...
      IF(LENLCM.NE.0) THEN
         ...
         CALL LCMGET(IPLIB,'TCEPS-SHIBA',TCEPS)
         CALL LCMSIX(IPLIB,' ',2)
         IGRMIN=IPAR(1)
         IGRMAX=IPAR(2)
         MAXX0=IPAR(3)
...
*        READ THE PRINT INDEX.
      ...
      ELSE IF(TEXT4.EQ.'EPS') THEN
         ...
         IF(ITYPLU.NE.2) CALL XABORT('TONE: REAL DATA EXPECTED(1).')
      ...
      ELSE IF(TEXT4.EQ.'ARM') THEN
         IPHASE=1
      ELSE IF(TEXT4.EQ.'TCEPS') THEN
         CALL REDGET(ITYPLU,NITMA,TCEPS,TEXT4,DFLOTT)
         IF(ITYPLU.NE.2) CALL XABORT('TONE: REAL DATA EXPECTED(2).')
...
*----
  100 IF(IPHASE.EQ.1) THEN
     ...
     2 VOL,IDL,LEAKSW,TITLE,IGRMIN,IGRMAX,MAXX0,ITRANZ,EPS,TCEPS)
*----
