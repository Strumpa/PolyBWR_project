...
*  LOCAL VARIABLES
*----
      INTEGER           IOUT, ICPALL, ICPEND, MXGAUS, NSTATE, NBCDA
...
*  Allocatable arrays
*----
      INTEGER, ALLOCATABLE, DIMENSION(:) :: MATRT,ICODE
      REAL, ALLOCATABLE, DIMENSION(:) :: FFACT,ALBG,ALBEDO
...
*----
      ...
      KSPEC=ISTATE(10)
      CALL LCMLEN(IPTRK,'ICODE',NBCDA,ITYPE)
