...
*  ALLOCATABLE ARRAYS
*----
      INTEGER, ALLOCATABLE, DIMENSION(:) :: INDPRO,ITYPRO,NAMI,IVECT
      REAL, ALLOCATABLE, DIMENSION(:) :: DENTMP,EMJMAC,XSREC,XSCAT,
     1 DISFC,DENSI,EMJI
...
*----
      ALLOCATE(IVECT(NEDMAC))
      IVECT(:NEDMAC)=0
      CALL CPONED(NPROC ,0,NL-1,MAX(1,ILEAKS),NEDMAC,HVECT,IVECT,INDPRO)
      INDPRO(6)=0
      INDPRO(16)=0
...
*----
     ...
     >              HVECT ,IVECT ,NPROC ,ILEAKS,DXSMAC,
...
*----
 ...
 110  CONTINUE
      ...
      IF(NISCPO.GT.0) DEALLOCATE(XSCAT,XSREC,IVECT)
*----
