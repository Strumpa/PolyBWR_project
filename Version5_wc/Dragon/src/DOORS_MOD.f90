  ...
  SUBROUTINE DOORS(CDOOR,IPTRK,NMAT,NANIS,NUN,SIGG,SUNKNO,FUNKNO)
    ...
    IF(CDOOR.EQ.'SN') THEN
      IF(PRESENT(FUNKNO)) THEN
        CALL DOORS_SN2(IPTRK,NANIS,NREG,NMAT,NUN,MATCOD,SIGG,SUNKNO,FUNKNO)
      ELSE
        CALL DOORS_SN1(IPTRK,NANIS,NREG,NMAT,NUN,MATCOD,SIGG,SUNKNO)
      ENDIF
    ELSE IF(CDOOR.EQ.'BIVAC') THEN
      IF(PRESENT(FUNKNO)) THEN
        CALL DOORS_BIV2(IPTRK,NANIS,NREG,NMAT,NUN,MATCOD,VOL,SIGG,SUNKNO,FUNKNO)
      ELSE
        CALL DOORS_BIV1(IPTRK,NANIS,NREG,NMAT,NUN,MATCOD,VOL,SIGG,SUNKNO)
      ENDIF
    ELSE IF(CDOOR.EQ.'TRIVAC') THEN
      IF(PRESENT(FUNKNO)) THEN
        CALL DOORS_TRI2(IPTRK,NANIS,NREG,NMAT,NUN,MATCOD,VOL,SIGG,SUNKNO,FUNKNO)
      ELSE
        CALL DOORS_TRI1(IPTRK,NANIS,NREG,NMAT,NUN,MATCOD,VOL,SIGG,SUNKNO)
      ENDIF
