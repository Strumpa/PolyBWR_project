...
*
      IF(IMPX.GT.1) THEN
         ...
         WRITE(IOUT,120) (IGP(I),I=16,27)
         WRITE(IOUT,130) (IGP(I),I=28,31),(IGP(I),I=35,37),IGP(40),EPSI
      ENDIF
*----
...
*
  ...
  110 FORMAT(/14H STATE VECTOR:/
     ...
     3 9HDG/3=AWD)/
     4 7H LL4   ,I8,36H   (ORDER OF THE MATRICES PER GROUP)/
     5 7H LX    ,I8,38H   (NUMBER OF MESHES ALONG THE X AXIS)/
     6 7H LY    ,I8,38H   (NUMBER OF MESHES ALONG THE Y AXIS)/
     7 7H LZ    ,I8,38H   (NUMBER OF MESHES ALONG THE Z AXIS)/
     8 7H NLF   ,I8,13H   (SN ORDER))
  120 FORMAT(
  ...
  130 FORMAT(
     1 7H NMCEL ,I8,30H   (0/>0: KBA SWAPPING OFF/ON)/
     2 7H IGAV  ,I8,45H   (CONDITION AT AXIAL AXIS FOR CYL./SPH. 1D)/
     3 7H LSHOOT,I8,38H   (0/1: SHOOTING METHOD IN 1D OFF/ON)/
     4 7H IBFP  ,I8,43H   (0/1/2: BFP SOLUTION OFF/GALERKIN/LIGOU)/
     5 7H EELEM ,I8,46H   (ORDER OF POLYNOMIAL USED IN ENERGY APPROX.,
     6 37H/1=CONSTANT/2=LINEAR/3=PARABOLIC/...)/
     7 7H ESCHM ,I8,46H   (METHOD OF ENERGY DISCRETISATION/1=HODD/2=D,
     8 8HG/3=AWD)/
     9 7H IGLK  ,I8,42H   (0=CLASSICAL SN/>0=GALERKIN QUADRATURE)/
     1 7H IBIHET,I8,47H   (0/1: DOUBLE HETEROGENEITY IS NOT/IS ACTIVE)/
     2 7H EPSI  ,1P,E11.1,41H  (CONVERGENCE CRITERION ON INNER ITERATI/
     3 4HONS))
      END
