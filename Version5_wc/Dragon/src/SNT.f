...
*----
      ...
      INTEGER IGP(NSTATE),ISTATE(NSTATE),NCODE(6),NITMA,EELEM,ESCHM
*----
   ...
   16 CONTINUE
     ...
     1   ' QUAD VALUE.')
      ...
      ELSE IF(TEXT4.EQ.'ALLG') THEN
         INSB=1
      ELSE IF(TEXT4.EQ.'OMPA') THEN
         NOMP=0
      ELSE IF(TEXT4.EQ.'OMPM') THEN
         CALL REDGET(INDIC,NOMP,FLOTT,TEXT4,DFLOTT)
         IF(INDIC.NE.1) CALL XABORT('SNT: INTEGER DATA EXPECTED(15).')
         IF(NOMP.LE.0) CALL XABORT('SNT: POSITIVE INTEGER EXPECTED.')
...
*
      IF(IMPX.GT.1) THEN
         ...
         WRITE(IOUT,120) (IGP(I),I=16,31),IGP(35),IGP(36),IGP(40),EPSI
      ENDIF
*----
...
*
  ...
  120 FORMAT(
     ...
     7 7H NMCEL  ,I8,38H   (0/1: DOMINO MULTITHREADING OFF/ON)/
     ...
     2 38H./1=CONSTANT/2=LINEAR/3=PARABOLIC/...)/
     3 7H ESCHM ,I8,45H   (METHOD OF ENERGY DISCRETISATION/1=HODD/2= ,
     3 9HDG/3=AWD)/
     4 7H IBIHET,I8,47H   (0/1: DOUBLE HETEROGENEITY IS NOT/IS ACTIVE)/
     5 7H EPSI  ,E11.1,45H  (CONVERGENCE CRITERION ON INNER ITERATIONS))
      END
