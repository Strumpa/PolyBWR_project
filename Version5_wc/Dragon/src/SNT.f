...
*
  ...
  120 FORMAT(
     ...
     3 9HDG/3=AWD)
     4 7H IGLK  ,I8,45H   (0=CLASSICAL SN/>0=GALERKIN QUADRATURE)/
     5 7H IBIHET,I8,47H   (0/1: DOUBLE HETEROGENEITY IS NOT/IS ACTIVE)/
     6 7H EPSI  ,E11.1,45H  (CONVERGENCE CRITERION ON INNER ITERATIONS))
      END
