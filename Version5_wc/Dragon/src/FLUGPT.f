...
*----
      ...
      DO 100 IGR=1,NGRP
        ...
        IF(ILNLCM.GT.0) THEN
          CALL LCMGET(KPMACR,'NTOT0',XSTOT(1,IGR))
          XSTOT(0,IGR)=0.0
        ELSE
          CALL LCMLIB(KPMACR)
...
*
     ...
     4 VOL,XSTOT,XSTRC,XSDIA,XSNUF,XSCHI,LREBAL,INITFL,NMERG,IMERG)
 1000 CONTINUE
*----
...
*----
      DEALLOCATE(XSTK,XSNUF,XSCHI,XSDIA,XSTRC,XSTOT,SOURO,FLUXO)
      RETURN
*----
*  FORMATS
*----
