*DECK MCGFLX
     ...
     1           IPTRK,IFTRAK,IPMACR,NDIM,K,KPN,NLONG,NREG,NSOUT,NBCDA,
     2           NG,NGEFF,NGIND,NZON,MATALB,V,FIMEM,QFR,M,NANI,MAXI,
     3           IAAC,KRYL,ISCR,NMU,NANGL,NMAX,LC,EPSI,CAZ0,CAZ1,CAZ2,
     4           CPO,ZMU,WZMU,LFORW,PACA,NLIN,NFUNL,KEYFLX,KEYCUR,SIGAL,
     5           LPS,REPS,EPS,ITST,NCONV,LNCONV,REBFLG,STIS,NPJJM,
...
*----
      ...
      INTEGER NGEFF,IPRINT,IFTRAK,NDIM,K,KPN,NLONG,NREG,NSOUT,NBCDA,
     1 NG,NGIND(NGEFF),NZON(NLONG),MATALB(-NSOUT:NREG),M,NANI,MAXI,
     ...
     1 ZMU(NMU),WZMU(NMU),SIGAL(-NBCDA:M,NGEFF),REPS(MAXI,NGEFF),
     2 EPS(NGEFF),DELU,FACSYM
...
*     ----------------------
     ...
     1        IPTRK,IFTRAK,IPMACR,NDIM,K,KPN,NLONG,FLUX,NZON,MATALB,
     2        M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,SOUR,IAAC,ISCR,LC,
     3        LFORW,PACA,ITST,MAXI,QFR,FIMEM,CAZ0,CAZ1,CAZ2,CPO,ZMU,
     4        WZMU,V,EPS,EPSI,REPS,KRYL,SIGAL,LPS,NG,NGEFF,NGIND,NCONV,
     5        LNCONV,NLIN,NFUNL,KEYFLX,KEYCUR,STIS,NPJJM,REBFLG,LPRISM,
     6        N2REG,N2SOU,NZP,DELU,FACSYM,IDIR,NBATCH)
      ELSE
*     --------------------------
...
*     --------------------------
     ...
     2        M,NANI,NMU,NMAX,NANGL,NREG,NSOUT,NBCDA,SOUR,IAAC,ISCR,LC,
     3        LFORW,PACA,ITST,MAXI,QFR,FIMEM,CAZ0,CAZ1,CAZ2,CPO,ZMU,
     4        WZMU,V,EPS,EPSI,REPS,SIGAL,LPS,NG,NGEFF,NGIND,NCONV,
     5        LNCONV,NLIN,NFUNL,KEYFLX,KEYCUR,STIS,NPJJM,REBFLG,LPRISM,
     6        N2REG,N2SOU,NZP,DELU,FACSYM,IDIR,NBATCH)
      ENDIF
*----
