...
*----
     ...
     > ISONR,LSISO,INADPL,KDRI,INNAM,INNRF,NMIX
      INTEGER, ALLOCATABLE, DIMENSION(:,:) :: FIPI
...
*----
        ...
        IF(ILLCM.NE.0) THEN
          ...
          NDFP=IDIM(3)
          NREAC=IDIM(8)
          ALLOCATE(FIPI(NBISO,NMERGE),PYIEL(NDFI*NBISO*NMERGE))
*
...
*
     ...
     >                KDRI,RRD,FIYI,DECAY,YIELD,FIPI,PYIEL)
*
...
*----
     ...
     >             NW,MATCOD,VOLUME,KEYFLX,CURNAM,IGCOND,IMERGE,FLUXES,
     >             AFLUXE,EIGENK,EIGINF,B2,DEN,ITYPE,LSISO,EMEVF,EMEVG,
     >             DECAY,YIELD,FIPI,PYIEL,ITRANC,LISO,NMLEAK)
      ENDIF
*----
...
*----
     ...
     >              TAUXT,FLUXC,SCATS,ILEAKS,B2,NW,NTAUXT)
      ENDIF
*
      IF(NDFI.GT.0) DEALLOCATE(PYIEL,FIPI)
