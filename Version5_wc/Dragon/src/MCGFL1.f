*DECK MCGFL1
     ...
     2           MATALB,M,NANI,NMU,N2MAX,NANGL,NREG,NSOUT,NBCDA,NG,
     3           NGEFF,NGIND,S,IAAC,ISCR,LC,LFORW,PACA,EPSACC,MAXACC,
     4           NLIN,NFUNL,KEYFLX,KEYCUR,QFR,PHIIN,CAZ0,CAZ1,CAZ2,CPO,
     5           ZMU,WZMU,V,SIGAL,LPS,NCONV,LAST,STIS,NPJJM,REBFLG,
...
*---
     ...
     2 NBCDA,ISCR,LPS,NLIN,NFUNL,KEYFLX(NREG,NLIN,NFUNL),
     3 KEYCUR(NLONG-NREG),MAXACC,STIS,NPJJM,MATALB(-NSOUT:NREG),
     4 N2REG,N2SOU,NZP,IDIR,NBATCH
      REAL QFR(KPN,NGEFF),PHIIN(KPN,NGEFF),CPO(NMU),ZMU(NMU),WZMU(NMU),
     1 V(NLONG),SIGAL(-NBCDA:M,NGEFF),EPSACC,DELU,FACSYM
...
*----
      ...
      DO II=1,NGEFF
         IF(NCONV(II)) THEN
           ...
           CALL MCGFCS(NLONG,NDIMB,NZON,QFR(1,II),PHIIN(1,II),NBCDA,M,
     1     NANI,NLIN,NFUNL,XSSC,S(1,II),KPN,NREG,IPRINT,KEYFLX,KEYCUR,
     2     IBC,SIGAL(-NBCDA,II),STIS)
         ENDIF
      ENDDO
*---
...
*     --------------------------------
     ...
     1        N2MAX,NDIM,KPN,NREG,NSOUT,M,NBCDA,NGEFF,NANGL,NMU,NANI,
...
*
     ...
     1           K,NREG,NBCDA,M,NGEFF,NANGL,NMU,NANI,NFUNL,NMOD,KEYFLX,
...
*        REGULAR 2D OR 3D GEOMETRY
     ...
     1           NDIM,KPN,K,NREG,NBCDA,M,NGEFF,NANGL,NMU,NANI,NFUNL,
     2           NMOD,NANIX,NLIN,NFUNLX,KEYFLX,KEYCUR,NZON,NCONV,CAZ0,
     3           CAZ1,CAZ2,CPO,ZMU,WZMU,S,SIGAL,ISGNR,IDIR,NSOUT,NBATCH,
