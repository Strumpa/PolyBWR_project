...
CONTAINS
  ...
  & ZCODE,QEXT,LFIXUP,DU,DE,DZ,W,MRMZ,DC,DB,DA,MN,DN,WX,WY,WZ,CST,LOZSWP,H2CMAP,FUNKNO,ISCHM)
    ...
    DO JND=1,12
        ...
        !$OMP PARALLEL DEFAULT(SHARED) PRIVATE(ITID,IG,IPQD,ICEL,I,J,K,K_MC,IHEX_XY,DCOORD,IOF,M,IDI,NMAX,NCEL,J_MC,JIM) &
        !$OMP PRIVATE(I_MC,IIM,I_END,I_STT,J_STT,J_END,III,JJJ,KKK)
