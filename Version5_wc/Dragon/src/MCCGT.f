...
*----
      ...
      INTEGER ITRK,IFTR,IGEO,IFTRAK,J,NCOMNT,NBTR,ICOM,NBCDA,ITYLCM,
     ...
     1 COMNT(10)*80
      ...
      INTEGER IGP(NSTATE),KTITL(18),IGB(8)
      REAL ZREAL(4),ZMU(MXGAUS),WZMU(MXGAUS),XMU(MXGAUS),EXTKOP(NSTATE),
     1 XMU0(2*MXGAUS),WZMU0(2*MXGAUS)
...
*----
     ...
     3 NCODE
      ...
      REAL, ALLOCATABLE, DIMENSION(:) :: ZZ,VV,RTEMP,VA,VOL,ALBEDO
...
*     3D PRISMATIC GEOMETRY
         CALL LCMLEN(IPTRK,'NCODE',NBCDA,ITYLCM)
         ALLOCATE(NCODE(NBCDA))
