...
*----
      ...
      PARAMETER(NSTATE=40)
      CHARACTER HREAC(NREAC)*12,TEXT12*12,SUFF*2,TEXT1*1
...
*----
      ALLOCATE(VOLI(NZS),WORK(NBMIX),RATE(NZS),FLINT(NZS,NGRP),
...
*----
      ...
      IF(LENGT.GT.0) THEN
        CALL LCMGTC(IPMAC1,'PARTICLE',1,TEXT1)
        CALL LCMPTC(IPMAC2,'PARTICLE',1,TEXT1)
      ENDIF
      IDATA(:NSTATE)=0
      IDATA(1)=NGCOND
      IDATA(2)=NZS
